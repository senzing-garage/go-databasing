...
CREATE TABLE LIB_FEAT (LIB_FEAT_ID BIGINT NOT NULL, FTYPE_ID smallint NOT NULL, FEAT_HASH CHAR(40) NOT NULL, FEAT_DESC VARCHAR(150), FELEM_VALUES CLOB(3000) NOT NULL, ANONYMIZED VARCHAR(5) NOT NULL, VERSION smallint NOT NULL, PRIMARY KEY(LIB_FEAT_ID)) ;
...
CREATE TABLE SYS_HW_CHECK (LIB_FEAT_ID BIGINT NOT NULL, FTYPE_ID smallint NOT NULL, FEAT_HASH CHAR(40) NOT NULL, FEAT_DESC VARCHAR(150), FELEM_VALUES CLOB(3000) NOT NULL, ANONYMIZED VARCHAR(5) NOT NULL, VERSION smallint NOT NULL, PRIMARY KEY(LIB_FEAT_ID)) ;
...
CREATE TABLE DSRC_RECORD (DSRC_ID smallint NOT NULL, RECORD_ID VARCHAR(250) NOT NULL, ETYPE_ID smallint NOT NULL, ENT_SRC_KEY VARCHAR(250) NOT NULL, OBS_ENT_HASH CHAR(40) NOT NULL, JSON_DATA CLOB, CONFIG_ID BIGINT, FIRST_SEEN_DT TIMESTAMP, LAST_SEEN_DT TIMESTAMP, PRIMARY KEY(RECORD_ID, DSRC_ID)) ;
...
CREATE TABLE RES_ENT_OKEY (OBS_ENT_ID BIGINT NOT NULL, LENS_ID smallint NOT NULL, RES_ENT_ID BIGINT NOT NULL, ER_ID BIGINT NOT NULL, ERRULE_ID smallint NOT NULL, MATCH_KEY CLOB(1000), PRIMARY KEY(OBS_ENT_ID, LENS_ID)) ;
